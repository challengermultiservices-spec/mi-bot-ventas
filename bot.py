...
def ejecutar_sistema_automatico():
    ...
    try:
        ...
        # 2. Gemini: URL CORREGIDA A v1beta
        url_gemini = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key={gemini_key}"
        
        payload_gemini = {
            "contents": [{
                "parts": [{"text": "Dame un producto viral de cocina para TikTok. Responde estrictamente en este formato: NOMBRE | BUSQUEDA | HOOK | SCRIPT"}]
            }]
        }
        ...
        print(f"🎬 Creando video para: {producto}...")
        ...
        # Creatomate devuelve una lista, tomamos el primer elemento
